...
class Preprocessor:
    def __init__(self, selected_features_path: Optional[str] = None):
        ...
        # Load selected features if provided (for v4.0+)
    ...
    def _prepare_features(self, df: pd.DataFrame, fit: bool = False) -> pd.DataFrame:
        ...
        # Apply feature selection if enabled (v4.0+)
    ...
    def load(cls, path: str) -> 'Preprocessor':
        ...
        preprocessor.selected_features = data.get('selected_features')  # Backwards compat
...
def prepare_data_for_training(
    ...
    print("Filtering out rows with missing price...")
